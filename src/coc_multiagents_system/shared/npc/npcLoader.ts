...
import { CoCDatabase } from '../database/schema.js';
import {
    ParsedNPCData,
    NPCProfile,
    CharacterAttributes,
 ...
 */
function calculateDefaultStatus(attributes: CharacterAttributes): CharacterStatus {
...
export class NPCLoader {
    ...
    private convertToNPCProfile(parsedData: ParsedNPCData): NPCProfile {
        ...
        const relationships: NPCRelationship[] = (parsedData.relationships || []).map((rel, index) => ({
