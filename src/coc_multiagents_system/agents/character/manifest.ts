...
export const CHARACTER_AGENT_MANIFEST: AgentManifest = {
  ...
  purpose:
    "Maintains character sheets, tracks inventory and equipment, manages character progression, enforces character limitations",
  capabilities: [
    {
      name: "loadCharacter",
    ...
    },
    {
      ...
      parameters: [
        ...
        },
        {
          name: "stat",
          type: "string",
          description: 'Stat name (e.g., "hp", "sanity", "Spot Hidden")',
          required: true,
        },
        {
          name: "value",
    ...
    },
    {
      ...
      description:
        "Returns list of actions character can perform based on skills and equipment",
      parameters: [
        {
          name: "characterId",
          type: "string",
    ...
    },
    {
      ...
      parameters: [
        ...
        },
        {
          name: "skill",
          type: "string",
          description: "Skill that improved",
          required: true,
        },
      ],
