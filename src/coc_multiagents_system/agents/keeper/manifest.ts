...
export const KEEPER_AGENT_MANIFEST: AgentManifest = {
  ...
  purpose:
    "Creates atmospheric descriptions, portrays NPCs, designs scenarios, manages clues, builds tension, improvises responses",
  capabilities: [
    {
      name: "narrateScene",
      ...
      parameters: [
        ...
        },
        {
          name: "context",
          type: "any",
          description: "Recent events and situation",
          required: true,
        },
        {
          name: "mood",
          type: "string",
          description: "Desired atmosphere (mysterious, tense, calm, etc.)",
          required: false,
        },
      ],
    ...
    },
    {
      ...
      parameters: [
        ...
        },
        {
          name: "playerInput",
          type: "string",
          description: "What player said/did",
          required: true,
        },
        {
          name: "context",
    ...
    },
    {
      ...
      parameters: [
        ...
        },
        {
          ...
          type: "string",
          description: "How it was found (Spot Hidden, Library Use, etc.)",
          required: true,
        },
      ],
      ...
      parameters: [
        {
          name: "playerAction",
          type: "string",
          description: "Unexpected action taken",
          required: true,
        },
        {
          name: "context",
