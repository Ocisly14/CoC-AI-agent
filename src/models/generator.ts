...
/**
 * Model selection helpers for specific CoC tasks
 */

export const CoCModelSelectors = {
  /**
   * For quick keeper responses and simple rule lookups
   */
  quickResponse: () => ModelClass.SMALL,

  /**
   * For standard character interactions and agent responses
   */
  characterInteraction: () => ModelClass.MEDIUM,

  /**
   * For complex rule interpretations and game analysis
   */
  keeperAnalysis: () => ModelClass.LARGE,

  /**
   * For memory agent queries and context retrieval
   */
  memoryQuery: () => ModelClass.MEDIUM,

  /**
   * For action resolution and dice roll interpretations
   */
  actionResolution: () => ModelClass.MEDIUM,

  /**
   * For orchestrator decision making
   */
  orchestration: () => ModelClass.SMALL,

  /**
   * For complex narrative generation and storytelling
   */
  narrativeGeneration: () => ModelClass.LARGE,
};